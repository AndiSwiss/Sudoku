...
//        sudo9easy.solve();
        ...
        //todo: make the methods throw the errors -> so it can be used better for error-tracking (with more enhanced error-messages (more info, WHEN excactly it happened)
